// 全局状态
        ...
        // 更新零件选择
        function updatePartSelection(side, value) {
            partSelection[side] = value;
            updateUI();
        }
        ...
        function renderTable() {
            ...
            for (var i = 0; i < workPlans.length; i++) {
                ...
                var imageCell = '';
                if (plan.image) {
                    imageCell = '<div class="image-container uploaded" onclick="viewImage(' + plan.id + ')">' +
                    ...
                    imageCell = '<div class="image-container upload" onclick="uploadImage(' + plan.id + ')">' +
        ...
        function editPlan(planId) {
            ...
            // 恢复零件选择
            if (plan.partSelection) {
                partSelection = JSON.parse(JSON.stringify(plan.partSelection));
                document.getElementById('leftPart').value = partSelection.left || '';
                document.getElementById('rightPart').value = partSelection.right || '';
            } else {
                resetPartSelection();
            }
        ...
        function savePlan() {
            ...
            var newPlan = {
                ...
                partSelection: JSON.parse(JSON.stringify(partSelection)),
        ...
        function resetPartSelection() {
            ...
            document.getElementById('leftPart').value = '';
            document.getElementById('rightPart').value = '';
        }
